...
<head>
    ...
    <title>Mesin Antrian Farmasi</title>
...
<body class="flex flex-col min-w-screen min-h-screen bg-gray-100">
    <header class="bg-blue-600 text-white p-4 text-lg">
        <h1 class="text-2xl font-bold">
            Mesin Antrian Farmasi RSIG
        </h1>
        <button id="farmasi-mode-button" class="bg-white text-blue-600 p-2 rounded absolute top-2 right-2">
